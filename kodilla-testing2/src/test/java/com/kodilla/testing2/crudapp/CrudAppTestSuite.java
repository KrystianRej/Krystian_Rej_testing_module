...
public class CrudAppTestSuite {
    public static final String BASE_URL = "https://krystianrej.github.io/";
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException{
        ...
        driverTrello.findElement(By.id("user")).sendKeys("krystian.rej@gmail.com");
        driverTrello.findElement(By.id("password")).sendKeys("berserker11");
